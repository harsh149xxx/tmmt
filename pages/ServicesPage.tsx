...
const ServicesPage = () => {
    return (
        <div>
            ...
            <section className='flex px-4 md:px-12 lg:px-24 py-10 flex-col lg:flex-row gap-12 lg:gap-0'>
            ...
            <section className='flex px-4 md:px-12 lg:px-24 py-10 flex-col lg:flex-row-reverse gap-12 lg:gap-0'>
            ...
            <section className='flex px-4 md:px-12 lg:px-24 py-10 flex-col lg:flex-row-reverse md:gap-12 lg:gap-0'>
                <div className='w-full lg:w-1/2 lg:pl-8'>
                    ...
                    <ol className='text-xl pl-5 list-decimal'>
