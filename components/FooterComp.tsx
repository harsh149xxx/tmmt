            ...
            <footer className={`rounded-t-3xl bg-col3`}>
                <div className="grid grid-cols-1 gap-3 px-7 py-12 text-black md:grid-cols-3 md:flex-row md:gap-0 md:px-16 lg:grid-cols-4 lg:px-32">
                    ...
                    <div className="right flex flex-col gap-1 md:order-3 lg:order-2  items-center">
                        ...
                        <span>Email: <a href="mailto:support@velocityclick.in" className="text-blue-700 ">support@K.in</a> </span>
                    </div>

                    <div className="middle flex flex-col gap-2 md:order-2 md:pl-12 lg:order-3  items-center">
                        {menuItems.map((item, index) => (
                            <button
                                className={`w-fit hover:text-col5 ${(pathname == `/${item.slug}` || pathname == `${item.slug}`) ? "text-col5" : "text-black"}`}
                    ...
                    <div className="right flex flex-col gap-3 md:order-4 md:mt-5 md:w-full lg:order-4  items-center">
                        ...
                        {/* bottom part of footer */}
                            ...
                            <div className="flex flex-wrap px-5 pb-4 gap-2">
                                <Link
                                    href="/privacy-policy"
                                    className="border-r h-fit border-black text-lg hover:text-col5 pr-2"
                                >
                                    Privacy Policy
                                </Link>
                                <Link
