...
const ServiceCard: React.FC<{ title: string, content: string, img: StaticImageData }> = ({title,content,img}) => {
  return (
      <div className="rounded-xl p-5 flex flex-col items-center gap-5 cursor-pointer transform transition-transform duration-300 hover:scale-[1.05] shadow-[0px_0px_5px_0px_#1a202c]">
